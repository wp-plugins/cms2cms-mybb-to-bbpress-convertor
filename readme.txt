...
Tags: myBB to bbPress, myBB to bbPress migration, convert myBB to bbPress, migrate myBB to bbPress, bbPress, mybb
...
This automated converter will help you move all the content from myBB to bbPress within several minutes.
...
= Features: =
* clearing data from WordPress bbPress website before migration (optional)
* migrating images / attachments to bbPress from myBB (optional)
* fixing broken relationships in the database (optional)

**Note. Theme and template aren’t migrated as well as user passwords. They will need to reset the passwords.**
...
1. Go to Admin -> Plugins, find “CMS2CMS myBB to bbPress Convertor” and click Activate
